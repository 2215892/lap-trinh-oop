...
/**
 * Lớp OtherImage. Cung cập một s�?hình ảnh cho chương trình
 */
public abstract class OtherImage {
	...
	/** The Constant BG. */
	public final static BufferedImage BG = Helper.loadImage(RES_DIR
			+ "BG.png");

	/** The Constant ICON. */
	public final static BufferedImage ICON = Helper
			.loadImage(RES_DIR + "ICON.png");

	/** The Constant TITLE_BG. */
	public final static BufferedImage TITLE_BG = Helper
