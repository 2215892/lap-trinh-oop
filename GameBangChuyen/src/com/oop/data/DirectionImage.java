...
public abstract class DirectionImage {
	...
	/** The Constant AUP. */
	public final static BufferedImage AUP = Helper.loadImage(dir + "AUP.png");

	/** The Constant AUP1. */
	public final static BufferedImage AUP1 = Helper.loadImage(dir + "AUP1.png");

	/** The Constant DOWN. */
	public final static BufferedImage DOWN = Helper.loadImage(dir + "DOWN.png");

	/** The Constant LEFT. */
	public final static BufferedImage LEFT = Helper.loadImage(dir + "LEFT.png");

	/** The Constant LINE. */
	public final static BufferedImage LINE = Helper.loadImage(dir + "LINE.png");
	...
	/** The Constant SRIGHT. */
	public final static BufferedImage SDOWNLEFT = Helper.loadImage(dir
			+ "SDOWNLEFT.png");
	...
	public final static BufferedImage UPRIGHT = Helper.loadImage(dir
			+ "UPRIGHT.png");
